...
# ====================== 8. Supervised Learning (Naive Bayes) ======================
st.markdown("---")
st.subheader("🤖 Supervised Learning - Klasifikasi Kategori Berita")
...
# Simpan model dan vectorizer (opsional)
# import pickle
# with open('model.sav', 'wb') as f:
#     pickle.dump(model, f)
